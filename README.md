...
General info for various storage devices and their directory structures.
...
| DESKTOP-TU98PR9 | USR | Lenovo ThinkPad used for school; also kwu-ubuntu |
...
├── config/       # Configuration miscellaneous (e.g., MATLAB color profile)
├── projects/     # Project directories, incl. workspaces, packages, libraries
├── datasets/     # General datafile repository
├── hardware/     # Firmware or related for hardware
